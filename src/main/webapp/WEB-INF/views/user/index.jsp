...
<%--@elvariable id="recommendations" type="java.util.List<org.jojen.wikistudy.domain.MovieRecommendation>"--%>
<%--@elvariable id="recommendation" type="org.jojen.wikistudy.domain.MovieRecommendation"--%>
<html>
  <head>
    <title>Profile</title>
  </head>
