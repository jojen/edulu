      ...
      <div class="span-5">
        <div class="profile-header">
          ...
          <div class="profile-header-details">          
            <h2>${course.title} (${course.year}) <img src="/images/rated_${stars}.png" alt="${stars} stars"/></h2>
          </div>
        ...
        <div class="span-half">
          ...
          <table>
            ...
            <tr>
              ...
              <td><a target="cineasts_link" href="http://www.amazon.com/s/?url=search-alias%3Daps&field-keywords=<c:url value="${course.title}"/>">Amazon</a> |
                  <a target="cineasts_link" href="http://www.cinebutler.com/search.html?searchBy=title&searchFor=<c:url value="${course.title}"/>">CineButler</a>
              </td>
            </tr>
            <tr>
              <th>In Cinemas</th>
              <td><a target="cineasts_link" href="http://www.google.com/movies?q=<c:url value="${course.title}"/>">Google Movies</a>
              </td>
            </tr>
          </table>
        </div>
          ...
          <h3>Trailers</h3>
            ...
            <c:choose>
                <c:when test="${not empty youtube}">
                    <iframe title="YouTube video player" width="200" height="143" src="http://www.youtube.com/embed/${course.youtubeId}?rel=0&controls=0&egm=1&fs=1" frameborder="0" allowfullscreen></iframe>
                </c:when>
                <c:otherwise>
                    <ul>
