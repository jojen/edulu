    ...
    <ul class="search-results">
      <c:forEach items="${movies}" var="course">
        <li>
          ...
          <a class="thumbnail" href="<c:url value="/movies/${course.id}" />"> <img src="<c:url value="${image}" />" /></a>
            <a href="/movies/${course.id}">${course.title}</a> <img alt="${course.stars} stars" src="/images/rated_${course.stars}.png"/>
