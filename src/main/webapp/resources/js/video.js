...
(function () {
    ...
    u.options = {techOrder: ["html5", "flash"], html5: {}, flash: {swf: u.Pb + "vjs.zencdn.net/c/video-js.swf"}, width: 300, height: 150, defaultVolume: 0, children: {mediaLoader: {}, posterImage: {}, textTrackDisplay: {}, loadingSpinner: {}, bigPlayButton: {}, controlBar: {}}};
    u.Na = {};
    ...
    u.k = function (a, c) {
        ...
        c = u.hc(c);
        d.S && d.S.call(a, c);
        if (e && !c.Bb())u.k(e, c); else if (!e && !c.zb() && (d = u.getData(c.target), c.target[c.type])) {
            d.disabled = f;
    ...
    t = u.o.prototype;
    t.e = function (a, c) {
        c = u.i.B({className: this.P(), innerHTML: '<div class="vjs-control-content"><span class="vjs-control-text">' + (this.pa || "Need Text") + "</span></div>", ad: "button", "aria-live": "polite", tabIndex: 0}, c);
    ...
    t.update = function () {
        if (this.b) {
            var a, c = this.xb(), d = this.handle, e = this.Fc;
            isNaN(c) && (c = 0);
            a = c;
            if (d) {
    ...
    u.na.prototype.e = function () {
        ...
        a = u.c.prototype.e.call(this, "div", {append: this.ra, className: "vjs-menu"});
    ...
    u.ea = u.o.extend({g: function (a, c) {
        u.o.call(this, a, c);
        this.ua = this.Fa();
        this.X(this.ua);
    ...
    t.Fa = function () {
        ...
        this.options().title && a.s().appendChild(u.e("li", {className: "vjs-menu-title", innerHTML: u.Y(this.A), jd: -1}));
    ...
    t.buffered = function () {
        var a = I(this, "buffered"), c = this.r.nb = this.r.nb || 0;
    ...
    t.src = function (a) {
        if (a instanceof Array) {
            ...
            c ? (a = c.source, c = c.h, c == this.ba ? this.src(a) : E(this, c, a)) : this.b.appendChild(u.e("p", {innerHTML: 'Sorry, no compatible source and playback technology were found for this video. Try using another browser like <a href="http://bit.ly/ccMUEC">Chrome</a> or download the latest <a href="http://adobe.ly/mwfN1">Adobe Flash Player</a>.'}))
        } else a instanceof
    ...
    u.da = u.c.extend({g: function (a, c) {
        u.c.call(this, a, c);
        a.controls() || this.disable();
        a.Q("play", u.bind(this, function () {
            var a, c = u.bind(this, this.ja), g = u.bind(this, this.Ga);
            this.ja();
            ...
            this.a.d("touchend", u.bind(this, function (c) {
                var e;
                a && (e = this.s().className.search("fade-in"),
                    -1 !== e ? this.Ga() : this.ja());
                a = l;
    ...
    u.da.prototype.f = {wd: "play", children: {playToggle: {}, currentTimeDisplay: {}, timeDivider: {}, durationDisplay: {}, remainingTimeDisplay: {}, progressControl: {}, fullscreenToggle: {}, volumeControl: {}, muteToggle: {}}};
    ...
    u.Xb = u.o.extend({g: function (a, c) {
        u.o.call(this, a, c);
    ...
    u.Ya = u.c.extend({g: function (a, c) {
        u.c.call(this, a, c);
    ...
    u.Za = u.c.extend({g: function (a, c) {
        u.c.call(this, a, c);
        a.d("timeupdate", u.bind(this, this.ya))
    }});
    ...
    u.Aa = u.o.extend({g: function (a, c) {
        u.o.call(this, a, c)
    }});
    ...
    u.bb = u.c.extend({g: function (a, c) {
        u.c.call(this, a, c);
    ...
    u.Wb = u.c.extend({g: function (a, c) {
        u.c.call(this, a, c)
    }});
    ...
    u.kb = u.c.extend({g: function (a, c) {
        u.c.call(this, a, c);
    ...
    u.bc = u.c.extend({g: function (a, c) {
        u.c.call(this, a, c)
    }});
    ...
    u.fa = u.o.extend({g: function (a, c) {
        u.o.call(this, a, c);
    ...
    u.Ca = u.ea.extend({g: function (a, c) {
        u.ea.call(this, a, c);
        a.d("volumechange", u.bind(this, this.update));
        a.h && (a.h.j && a.h.j.T === l) && this.p("vjs-hidden");
        a.d("loadstart", u.bind(this, function () {
    ...
    u.Ca.prototype.Fa = function () {
        var a = new u.na(this.a, {Ic: "div"}), c = new u.jb(this.a, u.i.B({md: f}, this.f.zd));
        a.X(c);
        return a
    };
    ...
    u.eb = u.o.extend({g: function (a, c) {
        u.o.call(this, a, c);
    ...
    u.Vb = u.c.extend({g: function (a, c) {
        u.c.call(this, a, c);
    ...
    u.Wa = u.o.extend({g: function (a, c) {
        u.o.call(this, a, c);
        a.controls() || this.v();
        a.d("play", u.bind(this, this.v))
    }});
    ...
    t.e = function () {
        var a = this.a, c = a.N;
        if (!c || this.j.Sc === l)c ? (a.s().removeChild(c), c = c.cloneNode(l)) : c = u.e("video", {id: a.id() + "_html5_api", className: "vjs-tech"}), c.player = a, u.yb(c, a.s());
    ...
    u.l = u.q.extend({g: function (a, c, d) {
        ...
        a = a.f;
        var k = u.i.B({readyFunction: "videojs.Flash.onReady", eventProxyFunction: "videojs.Flash.onEvent", errorEventProxyFunction: "videojs.Flash.onError", autoplay: a.autoplay, preload: a.Oa, loop: a.loop, muted: a.muted}, c.flashVars), q = u.i.B({wmode: "opaque", bgcolor: "#000000"}, c.params), n = u.i.B({id: j, name: j, "class": "vjs-tech"}, c.attributes);
    ...
    t.update = function () {
        if (0 < this.ia.length) {
            ...
            if (this.Kb === b || a < this.Kb || this.Ja <= a) {
                var c = this.ia, d = this.a.duration(), e = 0, g = l, j = [], k, q, n, s;
                a >= this.Ja || this.Ja === b ? s = this.vb !== b ? this.vb : 0 : (g = f, s = this.Cb !== b ? this.Cb : c.length - 1);
                for (; ;) {
                    n = c[s];
                    if (n.ta <= a)e = Math.max(e, n.ta), n.Da && (n.Da = l); else if (a < n.startTime) {
    ...
    u.cb = u.W.extend({g: function (a, c) {
        c.track = {H: function () {
            return c.kind
        }, pc: a, label: function () {
            return c.kind + " off"
    ...
    u.Ba = u.V.extend({g: function (a, c, d) {
        u.V.call(this, a, c, d);
    ...
    u.Sb = u.V.extend({g: function (a, c, d) {
        u.V.call(this, a, c, d);
    ...
    t.Fa = function () {
        ...
        if (g) {
            e = g.ia;
            for (var k, c = 0, d = e.length; c < d; c++)k = e[c], k = new u.Xa(this.a, {track: g, cue: k}), j.push(k), a.X(k)
        }
        0 < this.G.length && this.show();
        return a
    };
    u.Xa = u.I.extend({g: function (a, c) {
