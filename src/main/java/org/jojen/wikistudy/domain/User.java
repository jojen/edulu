...
public class User {
	...
	public Rating rate(Neo4jOperations template, Course course, int stars, String comment) {
		final Rating rating = template.createRelationshipBetween(this, course, Rating.class, RATED, false).rate(stars, comment);
