...
import org.jojen.wikistudy.util.jpacloner.graphs.EntityIntrospector;
...
public class JpaIntrospector implements EntityIntrospector {
	...
	/**
	 * Returns the raw JPA class (i.e. annotated by {@link javax.persistence.Entity} or {@link javax.persistence.Embeddable}) or <code>null</code>.
	 */
